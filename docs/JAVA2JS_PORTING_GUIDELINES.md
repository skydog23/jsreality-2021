...
4. **Static typing via JSDoc and tooling**  
...
5. **Method overloading → single runtime-dispatch function**  
...
6. **Concurrency and locking → single-threaded event/listener patterns**  
...
7. **AWT/Swing and other JVM-only types → minimal JS equivalents (Descriptors/Widgets for UI)**  
...
8. **Java collections and scene-data abstractions → JS arrays/typed arrays**  
...
9. **Numeric representation and performance**  
...
10. **I/O, serialization hooks, and no-op infrastructure**  
