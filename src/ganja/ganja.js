...
(function (name, context, definition) {
  ...
  //          if (o instanceof Element && o.length == 32) o = new Element([o[0],o[1],o[2],o[3],o[4],o[6],o[7],o[8],o[10],o[11],o[13],o[16],o[17],o[19],o[22],o[26]]); 
        ...
        // gl escape.
          if (options.jsr) return Element.graphJSR(f,options);
      ...
      // jsReality scene graph adapter. Requires GanjaAdapter to be registered first
      // via Element.useJSR(GanjaAdapter) from the calling ES module.
        static useJSR(adapterClass) { Element._GanjaAdapter = adapterClass; }
        static graphJSR(f,options) {
          if (!Element._GanjaAdapter) throw new Error('GanjaAdapter not registered. Call Element.useJSR(GanjaAdapter) first.');
          return Element._GanjaAdapter.render(Element, f, options);
        }
