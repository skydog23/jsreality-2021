  ...
  static getDefaultToolSystemConfiguration() {
    ...
    return new ToolSystemConfiguration({
      ...
      new RawMapping('Mouse', 'axes', InputSlot.POINTER_NDC),
        ...
        new RawMapping('Keyboard', 'VK_UP', InputSlot.getDevice('forward')),
        new RawMapping('Keyboard', 'VK_LEFT', InputSlot.getDevice('left')),
        new RawMapping('Keyboard', 'VK_DOWN', InputSlot.getDevice('backward')),
        new RawMapping('Keyboard', 'VK_RIGHT', InputSlot.getDevice('right')),
